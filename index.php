	...
	<div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="./images/index-banner.webp" class="d-block w-100" alt="index-banner" title="Demo Calenderz">
			</div>
			<div class="carousel-item">
				<img src="./images/index-banner2.webp" class="d-block w-100" alt="index-banner2" title="Demo Calendarz">
			</div>
		</div>
	</div>
	<!-- carousel ends -->
	...
	<section class="container py-5 introduction-section wow fadeInDown">
		<div class="row">
			...
			<div class="col-lg-6 text-center left-content">
				<img src="./images/index-first-left.webp" alt="Calendar Product" class="img-fluid main-product-image"
			...
			<div class="col-lg-6 right-content">
				...
				<div class="promotion">
					<img src="./images/index-calendar.webp" alt="2in1 Calendar" class="img-fluid promotion-image"
						title="Demo Calenderz">
				</div>
			</div>
		</div>
